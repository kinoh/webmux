...
const paneListEl = mustElement("paneList");
const captureEl = mustElement("capture");
const selectedTitleEl = mustElement("selectedTitle");
const statusEl = mustElement("status");
const commandInputEl = mustElement("commandInput");
const linesInputEl = mustElement("linesInput");
const sessionSelectEl = mustElement("sessionSelect");
const decreaseFontSizeBtn = mustElement("decreaseFontSizeBtn");
const increaseFontSizeBtn = mustElement("increaseFontSizeBtn");
const fitWidthBtn = mustElement("fitWidthBtn");
const refreshCaptureBtn = mustElement("refreshCaptureBtn");
const sendBtn = mustElement("sendBtn");
const sendEnterBtn = mustElement("sendEnterBtn");
const primarySpecialKeysEl = mustElement("primarySpecialKeys");
const toggleSpecialKeysBtn = mustElement("toggleSpecialKeysBtn");
const specialKeyPopoverEl = mustElement("specialKeyPopover");
const extraSpecialKeysEl = mustElement("extraSpecialKeys");
const customSpecialKeyFormEl = mustElement("customSpecialKeyForm");
const customSpecialKeyInputEl = mustElement("customSpecialKeyInput");
const specialKeyHintEl = mustElement("specialKeyHint");
const linesControlEl = mustElement("linesControl");
...
function getCurrentCaptureFontSize() {
...
function setCaptureFontSize(fontSize) {
...
function adjustCaptureFontSize(delta) {
